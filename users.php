...
<div class="page-actions"><button class="button" type="button" data-user-drawer-trigger aria-expanded="false" aria-controls="user-create-drawer">New user</button></div>
