...
function pagination_link(int $page, string $label, bool $current = false): string
{
    ...
    return '<a href="index.php?page=' . $page . '">' . e($label) . '</a>';
}
