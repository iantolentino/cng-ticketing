...
INSERT INTO role_permissions(role_id,permission_id,granted) SELECT r.id,p.id,1 FROM roles r JOIN permissions p WHERE r.slug IN ('super-admin','management','team-leader','department-head','pod-leader') AND p.permission_key='manage_recruitment';
